...
scheme_props1 = regionprops(scheme_mask,'Orientation');
scene_props1 = regionprops(scene_mask,'Orientation');

% scene_angle = scene_props.MaxAngle;
% scheme_angle = scheme_props.MaxAngle;
scene_angle = scene_props1.Orientation;
scheme_angle = scheme_props1.Orientation;
...
for i = 0:3
    ...
    tmp = imrotate(scene_mask,+angle-(90*i),'crop');
...
scene_mask = imrotate(scene_mask,+angle-(90*i),'crop');
